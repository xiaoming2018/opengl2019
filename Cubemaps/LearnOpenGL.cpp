...
int main()
{
	...
	while (!glfwWindowShouldClose(windows))
	{
		...
		skyShader.userShader();
		view = glm::mat4(glm::mat3(camera.GetViewMatirx())); // remove translation from the view matrix
...
GLFWwindow* init()
{
	...
	glfwSetScrollCallback(windows, scroll_callback);   // 设置滑轮滚动函数 
